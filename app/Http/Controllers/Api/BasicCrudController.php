...
abstract class BasicCrudController extends Controller
{
    ...
    protected abstract function resource(); //um só

    protected abstract function resourceCollection(); //um só
    ...
    public function index(Request $request)
    {
        ...
        $data = $request->has('all') || !$this->defaultPerPage
            ? $query->get()
            : ($hasFilter ? $query->paginateFilter($perPage) : $query->paginate($perPage));
    ...
    //PUT - atualizar o recurso por inteiro
    ...
    {
        $model = $this->model();
        $keyName = (new $model)->getRouteKeyName(); //id
